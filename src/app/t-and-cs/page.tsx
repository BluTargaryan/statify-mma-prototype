  ...
  return (
    ...
    xl:gap-32 xl:w-4/5 xl:mx-auto'>
      <section className='flex flex-col gap-6 items-center md:gap-16'>
        ...
        <p className="text-center max-w-2xl">Welcome to StatifyMMA! By accessing and using our website, you agree to comply with and be bound by the following terms and conditions. Please read these terms carefully. If you do not agree to these terms, you should not use this site.</p>
        ...
        <div className='flex flex-col gap-6 max-w-4xl mx-auto px-4'>
          ...
          <article className='flex flex-col gap-3'>
            ...
            <p>We collect basic user data as outlined in our <a href="/privacy-policy" className="text-primary hover:text-secondary transition-colors">Privacy Policy</a>.</p>
          </article>
          ...
          <article className='flex flex-col gap-3 mt-6'>
            <p>If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:hello@statifymma.com" className="text-primary hover:text-secondary transition-colors">hello@statifymma.com</a>.</p>
          </article>
        </div>
      </section>
    </main>
